...
<html lang="en">
	...
	<head><base href="../">
		<meta charset="utf-8" />
		<title>My Calendar | Technopartner Indonesia </title>
						...
						<div class="aside-menu flex-column-fluid">
							...
							<div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_aside_logo, #kt_aside_footer" data-kt-scroll-wrappers="#kt_aside_menu" data-kt-scroll-offset="0">
								...
								<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true">
									...
									<div class="menu-item">
										<a class="menu-link" href="/absensi">
											<span class="menu-icon">
						...
						<div class="toolbar" id="kt_toolbar">
							...
							<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									<!--begin::Title-->
									<h1 class="d-flex align-items-center text-dark fw-bolder my-1 fs-3">Jadwal Shift Karyawan</h1>
									<!--end::Title-->
									<!--begin::Separator-->
							...
							<div id="kt_content_container" class="container">
								...
								<div class="card">
									...
									<div class="card-header">
										<img alt="Logo" src="assets/media/logos/logo3.png" class="h-80px logo" />
									</div>
									<!--end::Card header-->
									<!--begin::Card body-->
									<div class="card-body">
										...
										<div class="modal-content">
											...
											<form class="form" action="#" id="kt_modal_add_event_form">
												...
												<div class="modal-header">
													<!--begin::Modal title-->
													<h2 class="fw-bolder" data-kt-calendar="title">Atur Jadwal</h2>
													<!--end::Modal title-->
													<!--begin::Close-->
