		...
		<div class="d-flex flex-column flex-root">
			...
			<div class="d-flex flex-column flex-column-fluid bgi-position-y-bottom position-x-center bgi-no-repeat bgi-size-contain bgi-attachment-fixed" style="background-image: url(assets/media/illustrations/development-hd.png)">
				...
				<div class="d-flex flex-center flex-column flex-column-fluid p-10 pb-lg-20">
					<!--begin::Logo-->
					<a class="mb-12">
						<img alt="Logo" src="assets/media/logos/logo3.png" class="h-90px" />
					</a>
					<!--end::Logo-->
					<!--begin::Wrapper-->
					<div class="container">
						...
						<form class="form w-100"  action="/registeruser" method="post">
							...
							<div class="row fv-row mb-7">
								<!--begin::Col-->
									...
									<input class="form-control form-control-lg form-control-solid" type="text" placeholder="Insert name" name="name"  />
								<!--end::Col-->
							</div>
							<!--end::Input group-->
							<!--begin::Input group-->
							<div class="fv-row mb-7">
								...
								<input class="form-control form-control-lg form-control-solid" type="email" placeholder="Insert Email Addres" name="email" />
							</div>
							<!--end::Input group-->
							<!--begin::Input group-->
							<div class="mb-10 fv-row" data-kt-password-meter="true">
								...
								<div class="mb-1">
									...
									<div class="position-relative mb-3">
										<input class="form-control form-control-lg form-control-solid" type="password" placeholder="Insert password" name="password" />
